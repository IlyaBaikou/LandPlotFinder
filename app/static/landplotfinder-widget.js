(function () {
  ...
  function listingLink(item, unavailable = false) {
    const url = safeUrl(item.url);
    if (unavailable || url === "#") return "";
    return `<a class="lpf-source-link lpf-source-detail" href="${url}" target="_blank" rel="noopener noreferrer">Посмотреть фото и объявление ↗</a>`;
  }
