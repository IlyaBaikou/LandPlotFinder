(function () {
  ...
  function styles() {
    return `
      ...
      @media(max-width:980px){.lpf-filters{grid-template-columns:repeat(2,minmax(0,1fr))}.lpf-utility-options{grid-column:1/-1}.lpf-filters button{grid-column:auto}.lpf-grid{grid-template-columns:repeat(2,1fr)}.lpf-map-layout{grid-template-columns:220px 1fr}}@media(max-width:700px){.lpf-shell{border-radius:18px}.lpf-header,.lpf-filters,.lpf-grid{padding-left:20px;padding-right:20px}.lpf-header{display:block}.lpf-brand{display:inline-block;margin-top:18px}.lpf-filters{grid-template-columns:1fr}.lpf-utility-options{grid-column:1;display:grid;grid-template-columns:1fr 1fr;gap:12px}.lpf-filters button{grid-column:1;width:100%}.lpf-grid{grid-template-columns:1fr}.lpf-status{margin-left:20px;margin-right:20px}.lpf-bottom{padding-left:20px;padding-right:20px;display:grid;gap:10px}.lpf-toolbar{padding:0 20px;align-items:stretch;display:grid}.lpf-tabs{overflow:auto;overscroll-behavior-inline:contain}.lpf-sort{justify-content:space-between}.lpf-sort select{width:min(210px,60vw)}.lpf-gate{position:absolute;top:24px;transform:translateX(-50%);padding:24px}.lpf-preview{min-height:620px}.lpf-dialog-layer{padding:0}.lpf-detail{width:100%;min-height:100dvh;margin:0;border-radius:0;padding:22px 18px 28px}.lpf-detail-head{display:grid;padding-right:44px}.lpf-big-score{height:70px}.lpf-unavailable-banner{display:grid}.lpf-detail-grid{grid-template-columns:1fr}.lpf-detail-actions{grid-template-columns:1fr}.lpf-route-box{display:grid}.lpf-route-box>div:last-child{display:grid}.lpf-similar-list{grid-template-columns:1fr}.lpf-map-layout{grid-template-columns:1fr;padding:20px}.lpf-map-list{grid-template-columns:repeat(2,1fr);max-height:220px}.lpf-map-provider{grid-column:1/-1}.lpf-map-canvas,.lpf-map-canvas iframe{min-height:410px}.lpf-saved-intro{margin-left:20px;margin-right:20px;display:grid}.lpf-saved-tools{justify-content:space-between}.lpf-comparison{margin-left:20px;margin-right:20px}.lpf-comparison-grid{grid-template-columns:100px repeat(4,minmax(90px,1fr))}}@media(max-width:400px){.lpf-utility-options{grid-template-columns:1fr}.lpf-tabs{border-radius:16px}.lpf-tab{padding-inline:12px}.lpf-detail-facts,.lpf-utility-table{grid-template-columns:1fr}.lpf-map-list{grid-template-columns:1fr}}
    `;
  }
})();
