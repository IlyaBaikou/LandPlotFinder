...
накопленный каталог на сайте Tilda, подтверждает телефон одноразовым кодом и
фиксирует выбранный участок как потенциального клиента. Посмотреть дизайн и
возможности можно на **[отдельной странице виджета](WIDGET.md)**, а готовый
