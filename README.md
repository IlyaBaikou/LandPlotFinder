...
накопленный каталог на сайте Tilda, подтверждает телефон одноразовым кодом,
анонимизирует объявления и позволяет изучать их на карте, сохранять и
сравнивать на устройстве. В отдельном разделе панели менеджер видит явные
запросы помощи по конкретным вариантам вместе с телефоном и критериями поиска.
