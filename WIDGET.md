...
Клиентские сообщения с ссылкой на выбранное объявление и персональные новые
варианты проектируются как отдельный корпоративный бот. Сценарий подключения,
согласия и отписки описан в [CLIENT_TELEGRAM_BOT.md](docs/CLIENT_TELEGRAM_BOT.md).
